...
public class DendrogramPanel extends JPanel {
    ...
    private void setupUi(Cluster cluster){
    ...
    public void createCluster(double[][] distances , String[] names){
	
        Cluster cluster = createSampleCluster(distances , names);
        
        this.setupUi(cluster);
    }
...
/*    public static void main(String[] args) {
    ...
    private Cluster createSampleCluster(double[][] distances , String[] names) {
